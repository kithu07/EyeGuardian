...
export default function Home() {
  ...
  const handleStartBreak = useCallback(() => {
    ...
    // Trigger full-screen break mode (hides UI and shows a timer)
    if (typeof window !== 'undefined' && window.electronAPI?.startBreakMode) {
      window.electronAPI.startBreakMode();
    }
  }, [addLog]);
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <button
              ...
              className="px-4 py-2 bg-slate-800 hover:bg-slate-700 rounded-lg border border-slate-700/50 text-slate-300 hover:text-white transition-colors flex items-center gap-2"
            >
